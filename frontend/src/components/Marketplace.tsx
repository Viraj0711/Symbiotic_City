    ...
    <section id="marketplace" className="py-16 lg:py-24 rounded-3xl shadow-2xl" style={{backgroundColor: '#B3C893'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {listings.length === 0 ? (
          ...
          {(limit ? listings.slice(0, limit) : listings).map((listing) => (
            <div
              key={listing.id}
              className="bg-gray-800 border border-gray-700 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1 flex flex-col h-full"
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <p className="text-gray-400 mb-3 flex-grow">{listing.provider}</p>
