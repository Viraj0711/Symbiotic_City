...
const EmergencyServices: React.FC = () => {
  ...
  const loadEmergencyServices = async () => {
    try {
      ...
      setError('Unable to retrieve your location or emergency services. Showing default services.');
      ...
      <div className="bg-red-50 border border-red-200 rounded-lg p-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-red-700">For immediate emergencies, dial 911</p>
          </div>
          <div className="ml-auto">
            <button
              onClick={() => callService('911')}
      ...
      {userLocation && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-green-800">Location detected - showing nearest emergency services</span>
          </div>
        </div>
      )}
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm text-gray-500">{service.distance.toFixed(1)} mi</span>
                </div>
