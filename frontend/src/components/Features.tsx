      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-gray-700 rounded-xl p-6 border border-gray-600 hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1 hover:border-emerald-500"
            >
