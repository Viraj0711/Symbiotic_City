...
import { fadeIn, fadeInUp, fadeInLeft, fadeInRight, scaleIn, staggerContainer, staggerItem } from '../utils/animations';
          ...
          >
            ...
            >
              ...
              >
                <motion.div whileFocus={{ scale: 1.02 }}>
                  ...
                  <motion.input
                    ...
                    whileFocus={{ borderColor: '#059669', boxShadow: '0 0 0 3px rgba(5, 150, 105, 0.1)' }}
                  />
                </motion.div>
              ...
              <motion.button
                ...
                variants={staggerItem}
                whileHover={{ scale: 1.02, boxShadow: '0 10px 25px rgba(5, 150, 105, 0.3)' }}
                whileTap={{ scale: 0.98 }}
              >
            ...
            >
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-sm text-gray-600">
                  Don't see your question? <motion.button 
                    className="text-green-600 hover:text-green-700 font-medium"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >Send us a message</motion.button> and we'll help you out.
                </p>
              </div>
            </motion.div>
